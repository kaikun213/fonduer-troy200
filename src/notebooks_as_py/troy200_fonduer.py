...
get_ipython().system(' dropdb -h postgres -h postgres -h postgres -h postgres --if-exists troy200_col_row_data')
get_ipython().system(' createdb -h postgres -h postgres -h postgres -h postgres troy200_col_row_data')
